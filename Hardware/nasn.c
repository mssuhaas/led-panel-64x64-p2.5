...
int main()
{
    ...
    printf("%s", dataString);
    extractColumnNames(dataString, column_names_array, 4);
    printColumnNames(column_names_array, 4);
    free(dataString);
    return 0;
}
...
//         int numColumns = extractColumnNames(dataString, column_names_array, 20); // Adjust the array size as needed
//         printColumnNames(column_names_array, numColumns);
